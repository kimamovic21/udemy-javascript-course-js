...
const poll = {
    ...
    registerNewAnswer() {
        ...
        // Register answer
        // We are checking if the answer is below the length of this array
        // short circuiting
        // if answer is true, the end operator will keep going and if it's still true, then this.answer[answer] is executed
        // if either of these conditions is false, then the end operator will short circuit and this.answer[answer] is not executed
